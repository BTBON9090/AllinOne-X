        ...
        switch (_z.label) {
            ...
            case 40:
                ...
                _loop_1 = function (node) {
                    var name_1, exist, style, exist, style, font, err_2, exist, style;
            ...
            case 51:
                ...
                traverse_1 = function (node) { return __awaiter(_this, void 0, void 0, function () {
                    var key, e_7, key, e_8, key, e_9, key, e_10, _i, _a, child;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    traverse = function (node) { return __awaiter(_this, void 0, void 0, function () {
                        var name, isUserTarget, isTechTarget, bytes, image, rect, e_11, children, _i, children_3, child;
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
...
function pptStep3_Flatten(slides) {
    return __awaiter(this, void 0, void 0, function () {
        var _i, slides_3, slide, hasNested, loopCount, children, i, node, rect, _a, _b, node, font, e_12;
...
function pptStep4_Extract(slides) {
    return __awaiter(this, void 0, void 0, function () {
        var rgbToHex, i, slide, slideAbs, slideX, slideY, chunkBuffer, children, j, node, nodeAbs, centerX, centerY, el, stroke, shadow, visibleFill, style, isMultiLine, err_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
function pptStep5_ExportImages(slides) {
    return __awaiter(this, void 0, void 0, function () {
        var imgCount, i, slide, children, j, node, isTarget, bytes, fileName, e_13;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:

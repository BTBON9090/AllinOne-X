...
figma.ui.onmessage = function (msg) { return __awaiter(_this, void 0, void 0, function () {
    ...
    var selection, _a, pageName, slides, slides, slides, slides, slides, newSelection, _i, selection_1, node, frame, idx, children, _b, children_1, child, newSelection, _c, selection_2, node, r, idx, count, _d, selection_3, node, temp, _e, selection_4, node, img, asyncImg, size, t, pool, _f, pool_1, n, count_1, newSelection, _g, selection_5, node, frame, parent_1, index, newSel, _h, selection_6, node, lines, font, e_1, cy, _j, lines_1, l, t, tNodes, font, e_2, txt, nt, i, arr_1, arr_2, sel, targets_4, scan_1, count, _k, targets_1, node, h, pool, _l, pool_2, n, count_3, p_1, count_4, count_2, sel, f, pool, _m, selection_7, node, targets, _o, targets_2, node, _p, selection_8, node, results, _q, pool_3, node, match, n, q, t, ts, isType, isState, s, _r, _s, p, val, tgt, createdCount, conflicts, errors, localPaints, localTexts, localEffects, _loop_1, _t, selection_9, node, e_3, parts, sel, countFill_1, countStroke_1, countText_1, countEffect_1, paints, texts, effects, paintMap_1, effectMap_1, textMap_1, traverse_1, _u, sel_1, node, e_4, total, count, _v, selection_10, node, newX, newY, newW, newH, n1, n2, x1, y1, x2, y2, findText, replaceText, scope, count, textNodes_2, collect_1, _w, textNodes_1, node, font, e_5, cfg_1, targets_5, scopeNodes, collectTargets_1, results, convertName_1, tryReplace_1, findRegex_1, escape_1, pat, _loop_2, _x, targets_3, node, items, count, _y, items_1, item, node, err_1, node, err_2;
    var _this = this;
    return __generator(this, function (_z) {
        switch (_z.label) {
            case 0:
                ...
                _a = msg.type;
                switch (_a) {
                    case 'ppt-step-1': return [3 /*break*/, 1];
                    case 'ppt-step-2': return [3 /*break*/, 3];
                    case 'ppt-step-3': return [3 /*break*/, 5];
                    case 'ppt-step-4': return [3 /*break*/, 7];
                    case 'ppt-step-5': return [3 /*break*/, 9];
                    case 'to-frame': return [3 /*break*/, 11];
                    case 'to-rect': return [3 /*break*/, 12];
                    case 'swap-fs': return [3 /*break*/, 13];
                    case 'reset-image': return [3 /*break*/, 14];
                    case 'select-text': return [3 /*break*/, 19];
                    case 'remove-al': return [3 /*break*/, 20];
                    case 'add-al-wrapper': return [3 /*break*/, 21];
                    case 'split-text': return [3 /*break*/, 22];
                    case 'join-text': return [3 /*break*/, 30];
                    case 'up-one': return [3 /*break*/, 35];
                    case 'up-all': return [3 /*break*/, 36];
                    case 'rename-content': return [3 /*break*/, 37];
                    case 'detach-all': return [3 /*break*/, 38];
                    case 'remove-hidden': return [3 /*break*/, 39];
                    case 'sort-layers': return [3 /*break*/, 40];
                    case 'ungroup-all': return [3 /*break*/, 41];
                    case 'unlock-all': return [3 /*break*/, 42];
                    case 'fetch-selection-name': return [3 /*break*/, 43];
                    case 'find-and-select': return [3 /*break*/, 44];
                    case 'create-styles': return [3 /*break*/, 45];
                    case 'match-styles': return [3 /*break*/, 56];
                    case 'pixel-perfect': return [3 /*break*/, 67];
                    case 'swap-positions': return [3 /*break*/, 68];
                    case 'find-replace': return [3 /*break*/, 69];
                    case 'lint-variants': return [3 /*break*/, 79];
                    case 'fix-variants': return [3 /*break*/, 80];
                    case 'locate-node': return [3 /*break*/, 87];
                    case 'resize-drag': return [3 /*break*/, 91];
                    case 'resize-window': return [3 /*break*/, 91];
                }
                return [3 /*break*/, 92];
            case 1:
            ...
            case 14:
                ...
                _z.label = 15;
            case 15:
                if (!(_e < selection_4.length)) return [3 /*break*/, 18];
                node = selection_4[_e];
                if (!('fills' in node && Array.isArray(node.fills))) return [3 /*break*/, 17];
                img = node.fills.find(function (f) { return f.type === 'IMAGE'; });
                if (!(img && img.imageHash)) return [3 /*break*/, 17];
            ...
            case 22:
                ...
                _z.label = 23;
            case 23:
                if (!(_h < selection_6.length)) return [3 /*break*/, 29];
                node = selection_6[_h];
                if (node.type !== "TEXT")
                    return [3 /*break*/, 28];
            ...
            case 44:
                {
                    ...
                    if (f.scope === 'inside') {
                        ...
                        for (_o = 0, targets_2 = targets; _o < targets_2.length; _o++) {
                            node = targets_2[_o];
                            if ('findAll' in node)
                                pool = pool.concat(node.findAll(function (n) { return true; }));
                        }
                        ...
                        for (_p = 0, selection_8 = selection; _p < selection_8.length; _p++) {
                            node = selection_8[_p];
                            if ('children' in node)
                    ...
                    results = [];
                    for (_q = 0, pool_3 = pool; _q < pool_3.length; _q++) {
                        node = pool_3[_q];
                        match = true;
                        // Name
                        if (f.name.val) {
                        ...
                        if (match && f.types.vals.length > 0) {
                            t = node.type;
                            ts = f.types.vals;
                            isType = ts.includes(t);
                            if (ts.includes('AUTOLAYOUT') && t === 'FRAME' && node.layoutMode !== 'NONE')
                                isType = true;
                            if (ts.includes('IMAGE') && 'fills' in node && Array.isArray(node.fills) && node.fills.some(function (f) { return f.type === 'IMAGE'; }))
                                isType = true;
                        ...
                        if (match && f.states.vals.length > 0) {
                            ...
                            if (s.includes('locked') && node.locked)
                                isState = true;
                            if (s.includes('no-fill') && 'fills' in node && node.fills.length === 0)
                                isState = true;
                            if (s.includes('no-stroke') && 'strokes' in node && node.strokes.length === 0)
                                isState = true;
                            if (s.includes('no-children') && 'children' in node && node.children.length === 0)
                                isState = true;
                        ...
                        if (match && f.props.length > 0) {
                            for (_r = 0, _s = f.props; _r < _s.length; _r++) {
                                p = _s[_r];
                                val = 0;
                                if (p.key === 'width')
                                    val = node.width;
            ...
            case 49:
                ...
                _t = 0, selection_9 = selection;
                _z.label = 50;
            case 50:
                if (!(_t < selection_9.length)) return [3 /*break*/, 53];
                node = selection_9[_t];
            ...
            case 60:
                ...
                traverse_1 = function (node) { return __awaiter(_this, void 0, void 0, function () {
                    var key, e_6, key, e_7, key, e_8, key, e_9, _i, _a, child;
                ...
                _z.label = 61;
            case 61:
                if (!(_u < sel_1.length)) return [3 /*break*/, 64];
                node = sel_1[_u];
            ...
            case 67:
                {
                    ...
                    count = 0;
                    for (_v = 0, selection_10 = selection; _v < selection_10.length; _v++) {
                        node = selection_10[_v];
                        if (!node.removed) {
            ...
            case 69:
                ...
                _z.label = 70;
            case 70:
                if (!(_w < textNodes_1.length)) return [3 /*break*/, 78];
                node = textNodes_1[_w];
                if (!node.characters.includes(findText)) return [3 /*break*/, 77];
                _z.label = 71;
            case 71:
                _z.trys.push([71, 76, , 77]);
                font = node.fontName;
                if (!(font === figma.mixed)) return [3 /*break*/, 73];
            ...
            case 72:
                ...
                _z.sent();
                return [3 /*break*/, 75];
            case 73: return [4 /*yield*/, figma.loadFontAsync(font)];
            case 74:
                _z.sent();
                _z.label = 75;
            case 75:
            ...
            case 79:
                {
                    ...
                    if (cfg_1.scope === 'selection' && scopeNodes.length === 0) {
                    ...
                    results = [];
                    convertName_1 = function (str, style, keepEmoji, removeId) {
                        var s = str;
                        if (removeId)
                        ...
                        if (words && words.length > 0) {
                            ...
                            switch (style) {
                                case 'camelCase':
                                    newVal = lowerWords.map(function (w, i) { return i === 0 ? w : w.charAt(0).toUpperCase() + w.slice(1); }).join('');
                                    break;
                                case 'PascalCase':
                                    newVal = lowerWords.map(function (w) { return w.charAt(0).toUpperCase() + w.slice(1); }).join('');
                                    break;
                                case 'snake_case':
                                    newVal = lowerWords.join('_');
                                    break;
                                case 'kebab-case':
                                    newVal = lowerWords.join('-');
                                    break;
                                case 'UPPER':
                                    newVal = lowerWords.join(' ').toUpperCase();
                                    break;
                                case 'lower':
                                    newVal = lowerWords.join(' ').toLowerCase();
                                    break;
                            }
                        }
                        if (keepEmoji && emojiPrefix) {
                            var sep = (style === 'snake_case' ? '_' : (style === 'kebab-case' ? '-' : ' '));
                            newVal = emojiPrefix + sep + newVal;
                        }
                        return { changed: newVal !== str, val: newVal };
                    };
                    tryReplace_1 = function (str, regex, rText) {
                        if (typeof str !== 'string' || !str)
                            return { changed: false, val: str };
                        if (regex.test(str)) {
                            var newVal = str.replace(regex, rText || '');
                            return { changed: newVal !== str, val: newVal };
                        }
                        return { changed: false, val: str };
                    };
                    ...
                    _loop_2 = function (node) {
                        try {
                            ...
                            if (node.type === 'COMPONENT_SET') {
                                ...
                                // Lint/Find Name
                                var res = { changed: false, val: node.name };
                                if (cfg_1.mode === 'lint')
                                    res = convertName_1(node.name, cfg_1.style, cfg_1.emoji, cfg_1.removeId);
                                else if (findRegex_1 && cfg_1.targets.includes('propName'))
                                    res = tryReplace_1(node.name, findRegex_1, cfg_1.replaceText);
                                if (res.changed) {
                                    results.push({
                                        id: node.id,
                            ...
                            // --- B. Component (Variant or Independent) ---
                                ...
                                var groupId = isVariant ? node.parent.id : node.id;
                                var groupName = isVariant ? node.parent.name : node.name;
                                var iconType = isVariant ? 'COMPONENT_SET' : 'COMPONENT'; // 变体归类到 Set 图标下
                                ...
                                if (isVariant) {
                                    ...
                                    var props = rawName.split(',').map(function (p) { return p.trim(); });
                                    var hasChange_1 = false;
                                    var newProps = props.map(function (pair) {
                                        var parts = pair.split('=');
                                        if (parts.length < 2)
                                            return pair;
                                        var key = parts[0].trim();
                                        var val = parts[1].trim();
                                        var resVal = { changed: false, val: val };
                                        // 检查 Value
                                        if (cfg_1.mode === 'lint')
                                            resVal = convertName_1(val, cfg_1.style, cfg_1.emoji, false);
                                        else if (findRegex_1 && cfg_1.targets.includes('propValue'))
                                            resVal = tryReplace_1(val, findRegex_1, cfg_1.replaceText);
                                        if (resVal.changed) {
                                            hasChange_1 = true;
                                            return "".concat(key, "=").concat(resVal.val);
                                        }
                                        return pair;
                                    });
                                    if (hasChange_1) {
            ...
            case 84:
                err_1 = _z.sent();
                console.error("修复图层失败:", item.id, err_1);
                return [3 /*break*/, 85];
            case 85:
                _y++;
                return [3 /*break*/, 81];
            ...
            switch (_a.label) {
                case 0:
                    ...
                    traverse = function (node) { return __awaiter(_this, void 0, void 0, function () {
                        var name, isUserTarget, isTechTarget, bytes, image, rect, e_10, children, _i, children_3, child;
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
...
function pptStep3_Flatten(slides) {
    return __awaiter(this, void 0, void 0, function () {
        var _i, slides_3, slide, hasNested, loopCount, children, i, node, rect, _a, _b, node, font, e_11;
...
function pptStep5_ExportImages(slides) {
    return __awaiter(this, void 0, void 0, function () {
        var imgCount, i, slide, children, j, node, isTarget, bytes, fileName, e_12;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:

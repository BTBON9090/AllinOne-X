...
mg.ui.onmessage = async (rawMessage) => {
  ...
  switch (msg.type) {
    ...
    case 'generate-showcase': {
      ...
      setTextFontSize(title, 64); setTextFontName(title, { family: "Inter", style: "Bold" });
      ...
      setTextFontSize(badgeText, 20); setTextFontName(badgeText, { family: "Inter", style: "Bold" });
      ...
      if (drawProps) {
        ...
        setTextFontSize(specTitle, 24); setTextFontName(specTitle, { family: "Inter", style: "Bold" });
        ...
        properties.forEach(prop => {
          ...
          pName.characters = prop; setTextFontSize(pName, 15); setTextFontName(pName, { family: "Inter", style: "Medium" });
          ...
          Array.from(vals).forEach(val => {
            ...
            safeCornerRadius(pill, 6); pill.fills = [solidPaint({ r: 243/255, g: 244/255, b: 246/255 })];
            ...
            setTextFontSize(pVal, 13); setTextFontName(pVal, { family: "Inter", style: "Regular" });
      ...
      if (drawUsage) {
        ...
        setTextFontSize(usageTitle, 24); setTextFontName(usageTitle, { family: "Inter", style: "Bold" });
        ...
        setTextFontSize(doText, 15); setTextFontName(doText, { family: "Inter", style: "Medium" });
        ...
        setTextFontSize(dontText, 15); setTextFontName(dontText, { family: "Inter", style: "Medium" });
